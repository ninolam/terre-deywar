...
const Intro = () => {
  ...
  return (
    <section
      className='CircuitsIntro'
      style={{ backgroundImage: `url(${circuits[indexToShow].image})` }}
    >
      <Overlay className='dark' />
      <div className='CircuitsIntro__container'>
        <div className='CircuitsIntro__infos'>
          <h1 className='CircuitsIntro__title'>
            {circuits[indexToShow].title}
          </h1>
          <p className='CircuitsIntro__text'>
            {circuits[indexToShow].mainDescription}
          </p>
          <div className='CircuitsIntro__buttons'>
            <Button
              text='Découvrir le détail de ce circuit'
              classNameModifier='white20'
            />
